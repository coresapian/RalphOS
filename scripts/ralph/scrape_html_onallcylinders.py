#!/usr/bin/env python3
"""
OnAllCylinders HTML Scraper
Fetches full HTML content for discovered article URLs.
...
class OnAllCylindersHTMLScraper:
    ...
    def scrape_all_urls(self):
        ...
        print(f"\n{'='*60}")
        print("OnAllCylinders HTML Scraper")
        print(f"{'='*60}")
...
def main():
    scraper = OnAllCylindersHTMLScraper()
