...
Usage:
    python scripts/ralph/stealth_scraper.py --source custom_wheel_offset --limit 100
    python scripts/ralph/stealth_scraper.py --source modified_rides --reset
    python scripts/ralph/stealth_scraper.py --urls-file scraped_builds/source/urls.json
...
Examples:
  ...
  python stealth_scraper.py --urls-file scraped_builds/mysite/urls.json
