...
Usage:
    python scripts/ralph/test_scraper.py scraped_builds/modified_rides/scrape_html.py
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print(f"Example: {sys.argv[0]} scraped_builds/modified_rides/scrape_html.py")
        sys.exit(1)
