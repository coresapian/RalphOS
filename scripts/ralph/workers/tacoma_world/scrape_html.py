#!/usr/bin/env python3
"""
Tacoma World HTML Scraper
Downloads HTML pages for all discovered media URLs with retry logic and progress tracking.
"""
...
# Configuration
URLS_FILE = "/Users/core/MOTORMIA/Documents-data/GitHub/RalphOS/scraped_builds/tacoma_world/urls.json"
HTML_DIR = "/Users/core/MOTORMIA/Documents-data/GitHub/RalphOS/scraped_builds/tacoma_world/html"
PROGRESS_FILE = "/Users/core/MOTORMIA/Documents-data/GitHub/RalphOS/scraped_builds/tacoma_world/scrape_progress.json"
...
def get_filename_from_url(url):
    ...
    # Extract media ID from URL pattern: /media/title.ID/
    parts = url.rstrip('/').split('/')
    filename = parts[-1]

    # Handle URLs that end with just the ID (e.g., "733246")
    if filename.replace('.', '').isdigit():
        return f"media_{filename}.html"

    # Handle URLs with titles (e.g., "website-drop-announcementa.733246")
...
def main():
    print(f"[{datetime.now().isoformat()}] Starting Tacoma World HTML scraper...")
